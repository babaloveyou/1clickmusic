...
var
  ...
  //ENGINECONFIG
  ds_useprimary : Boolean;
  ds_buffersize : Cardinal;
  ds_cooplevel : Cardinal;
...
begin
  utf16buffer := Format('OneClickMusic\0%s\0%d\0{0}\0%s\0\0\0\0\0', [msn_icons, Integer(write), curTitle]);
  msndata.dwData := $547;
...
procedure showaboutbox;
begin
  MessageBox(0, '1ClickMusic 1.8.0 beta 2' + #13#10 +
    ...
    'Agradecimento especial ao Greel nessa versão.', '1ClickMusic 1.8.0 beta 2', MB_OK +
